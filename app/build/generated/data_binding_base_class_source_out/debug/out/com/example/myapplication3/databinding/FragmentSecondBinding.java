...
public final class FragmentSecondBinding implements ViewBinding {
  ...
  @NonNull
  public final Button startVoiceToText;
  ...
  private FragmentSecondBinding(@NonNull NestedScrollView rootView, @NonNull Button buttonSecond,
      @NonNull Button startVoiceToText, @NonNull TextView textviewSecond) {
    this.rootView = rootView;
    this.buttonSecond = buttonSecond;
    this.startVoiceToText = startVoiceToText;
  ...
  public static FragmentSecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.start_voice_to_text;
      Button startVoiceToText = ViewBindings.findChildViewById(rootView, id);
      if (startVoiceToText == null) {
        break missingId;
      }
      ...
      return new FragmentSecondBinding((NestedScrollView) rootView, buttonSecond, startVoiceToText,
          textviewSecond);
    }
